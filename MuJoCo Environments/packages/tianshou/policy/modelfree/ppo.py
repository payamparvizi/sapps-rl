...
class PPOPolicy(A2CPolicy):
    ...
    def ar_caps_fun(self, batch: Batch) -> Batch:
        ...
        obs_bar = np.random.normal(loc=batch.obs, scale=self._sigma_s_bar)
        mean_bar, act_bar, prob_act_bar = self.action_sampling(obs_bar)
    ...
    def ar_aps_fun(self, batch: Batch) -> Batch:
        ...
        obs_next = torch.tensor(batch.obs_next)
        ...
        DO = torch.norm(obs - obs_next, p=2, dim=-1).cpu() + noise2
    ...
    def action_fluctuation(self, batch: Batch) -> Batch:
        ...
        obs_fluc = torch.norm(obs - obs_next, p=2, dim=-1).cpu()
    ...
    def learn(  # type: ignore
        ...
        losses, clip_losses, vf_losses, ent_losses, act_flucs, K_acts, K_means = [], [], [], [], [], [], []
        for step in range(repeat):
            ...
            for minibatch in batch.split(batch_size, merge_last=True):
                ...
                act_fluc, K_act, K_mean = self.action_fluctuation(minibatch)
