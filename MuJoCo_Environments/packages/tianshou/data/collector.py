...
class Collector(object):
    ...
    def __init__(
        ...
        self.reset(False)
        self.task_sm = task_sm
        self.length_sm = length_sm
        self.episodes_sm = episodes_sm
    ...
    def collect(
        ...
        smoothness = compute_sm(task=self.task_sm, policy=self.policy, length=self.length_sm, episodes=self.episodes_sm)
        return {
            "n/ep": episode_count,
            "n/st": step_count,
            "rews": rews,
