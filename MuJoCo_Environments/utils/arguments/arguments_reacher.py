...
def get_args():
    ...
    parser.add_argument("--task", type=str, default="Reacher-v4")
    ...
    # CAPS parameters
    parser.add_argument("--lambda_T", type=float, default=1e-1)
    parser.add_argument("--lambda_S", type=float, default=5e-2)
    parser.add_argument("--sigma_s_bar", type=float, default=1)
    
    # APS parameters
    parser.add_argument("--lambda_P", type=float, default=1e-3)
    parser.add_argument("--c_homog", type=float, default=100)
    parser.add_argument("--noise_pym", type=float, default=1e-12)
    
    parser.add_argument("--length_sm", type=int, default=50)
