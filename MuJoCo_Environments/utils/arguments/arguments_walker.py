...
def get_args():
    ...
    parser.add_argument("--lambda_S", type=float, default=0.25)
    parser.add_argument("--sigma_s_bar", type=float, default=25)
    
    # APS parameters
    parser.add_argument("--lambda_P", type=float, default=0.4)
    parser.add_argument("--c_homog", type=float, default=25)
    parser.add_argument("--noise_pym", type=float, default=1e-9)
